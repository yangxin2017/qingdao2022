<template>
  <div class="app-container">
    <div class="left-container animated" :class="{'fadeOutLeft': !showPanel, 'fadeInLeft': showPanel}">
      ...
      <sq-card height="23%" class="sep" :title="'基本情况'">
    ...
    <div class="right-container  animated" :class="{'fadeOutRight': !showPanel, 'fadeInRight': showPanel}">
      <sq-card height="20%" :title="'出租车空驶率 32％'">
        <div class="chart">
          <sq-pie :data="pdata1"></sq-pie>
        </div>
      </sq-card>

      <sq-card height="20%" class="sep" :title="'网约车空驶率32％'">
        <div class="chart">
          <sq-pie :data="pdata1"></sq-pie>
        </div>
      </sq-card>
...
export default {
  ...
  data() {
    return {
      ...
      cd1: { title: '出租车企数量', dw: '件', val: 50 },
      cd2: { title: '网约车企数量', dw: '人', val: 10 },
