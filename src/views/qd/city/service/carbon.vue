<template>
  <div class="app-container">
    <div class="left-container animated" :class="{'fadeOutLeft': !showPanel, 'fadeInLeft': showPanel}">
      <sq-card height="18%" :title="'实时空气质量'">
        <div class="fk-lists">
    ...
    <div class="right-container  animated" :class="{'fadeOutRight': !showPanel, 'fadeInRight': showPanel}">
      <sq-card height="30%" :title="'空气质量分析'">
        <div class="chart">
          <sq-line></sq-line>
        </div>
      </sq-card>

      <sq-card height="30%" class="sep" :title="'路网能源日均消耗趋势'">
        <div class="chart">
          <sq-line></sq-line>
        </div>
      </sq-card>

      <sq-card height="30%" class="sep" :title="'路网碳排放分析'">
        <div class="chart">
...
export default {
  ...
  data() {
    return {
      ...
      ydDatas: [
        { id: 1, title: '空气质量', data: { type: 'text', val: '优', dw: '' } },
        { id: 2, title: 'AQI指数', data: { type: 'text', val: 74, dw: '' } },
        { id: 3, title: '日均交通碳排放总量', data: { type: 'text', val: 0.6, dw: '吨' } },
      ],
      ...
      pdata1: [
        { value: 1048, name: '骑行', dw: '辆' },
        { value: 735, name: '公交', dw: '辆' },
        { value: 735, name: '地铁', dw: '辆' },
        { value: 735, name: '小汽车', dw: '辆' },
      ],
      pdata2: [
