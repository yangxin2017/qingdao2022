<template>
  <div class="app-container">
    <div class="left-container animated" :class="{'fadeOutLeft': !showPanel, 'fadeInLeft': showPanel}">
      ...
      <sq-card height="30%" class="sep" :title="'车辆平均出行距离分布'">
        <div class="chart">
          <sq-bar></sq-bar>
        </div>
      </sq-card>

      <sq-card class="sep" height="15%" :title="'交通量'">
        <div class="card-body">
          <div class="fk-lists">
      ...
      <sq-card height="20%" class="sep" :title="'归属地分析'">
        <div class="chart">
...
export default {
  ...
  data() {
    return {
      ...
      cd1: { title: '监测机动车保有量', dw: '万辆', val: 589 },
      cd2: { title: '千人保有量', dw: '万辆', val: 234 },
      cd3: { title: '实时在途数', dw: '万辆', val: 532 },
      cd4: { title: '日活跃车辆数', dw: '万辆', val: 675 },
