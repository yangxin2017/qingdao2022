<template>
  <sq-card class="sep" height="20.5%" :title="'车辆管理'">
    <template slot="right">
    ...
    <div class="card-body pabel-container h-con">
      <v-hor-mul-layout :widths="['12%', '12%', '75%']" :hasHead="false">
        <template slot="mod-0">
          <sq-v-icon-text class="fk" :title="'车位总计'" :data="stData">
            <template slot="image">
              <div class="lf">
        ...
        <template slot="mod-1">
          <sq-v-icon-text class="fk" :title="'空余车位'" :data="mdData">
            <template slot="image">
              <div class="lf">
                <img src="@/assets/images/icons/alert.png" />
              </div>
...
export default {
  ...
  data() {
    return {
      stData: { type: 'text', val: 500, dw: '个' },
      mdData: { type: 'text', val: 100, dw: '个' },

      columns: [
        { name: '序号', prop: 'xh' },
        { name: '进厂时间', prop: 'etime' },
        { name: '离厂时间', prop: 'ltime' },
        { name: '车牌号', prop: 'code' },
        { name: '操作', prop: 'op' },
      ],
      tableData: [
        { id: 1, xh: 1, etime: '2022-04-05 12:00:00', ltime: '2022-04-05 12:00:00', code: '京·A12365', op: { txt: '查看轨迹', val: 1 } },
        { id: 2, xh: 2, etime: '2022-04-05 12:00:00', ltime: '2022-04-05 12:00:00', code: '京·A12365', op: { txt: '查看轨迹', val: 1 } },
        { id: 3, xh: 3, etime: '2022-04-05 12:00:00', ltime: '2022-04-05 12:00:00', code: '京·A12365', op: { txt: '查看轨迹', val: 1 } },
        { id: 4, xh: 4, etime: '2022-04-05 12:00:00', ltime: '2022-04-05 12:00:00', code: '京·A12365', op: { txt: '查看轨迹', val: 1 } },
      ]
    }
  }
}
