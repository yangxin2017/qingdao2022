<template>
  <div class="sq-header">
    <div class="menu">
      <div
        class="nav-button"
        v-for="item in menusLeft"
        :key="item.id"
        :class="{ 'nav-button-click': curPath == item.path }"
      >
      ...
      menusLeft: [
        {
          ...
          path: "/sq/data",
          children: [
            { id: "l11", title: "运行监测", path: "/urban/monitor" },
            { id: "l12", title: "城市分析", path: "/urban/urban" },
            { id: "l13", title: "城际交通方式分析", path: "/urban/mode" },
          ],
        },
        {
          id: "l2",
