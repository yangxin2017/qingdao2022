import { EllipsoidSurfaceAppearance, GeometryInstance, Material, Primitive, Rectangle, RectangleGeometry, SingleTileImageryProvider, ImageryLayer, ImageMaterialProperty, Entity }
	from "cesium/Cesium";
...
export class CesiumHeatmap {
	constructor(viewer, options) {
		...
		/**
		 * west: 120.119034969,
		east: 120.30460437414949,
		south: 35.938738587540975,
		north: 36.021335537
		 */
		this.bounds = [0, 0, 0, 0];
